// Собственные flag.Value: типы флагов, которых нет в stdlib. Отдельно от
// flags.go — меняются они, когда меняется правило разбора, а не когда
// в наборе прибавляется флаг.
package main
